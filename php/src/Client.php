...
namespace APIVerve\Currencysymbols;
...
/**
 * Client for the Currency Symbols API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/currencysymbols?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/currencysymbols';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CurrencysymbolsClient] {$message}\n";
        }
    }
}
