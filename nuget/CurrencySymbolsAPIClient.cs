...
namespace APIVerve.API.CurrencySymbols
{
    ...
    /// <summary>
    /// Client for the CurrencySymbols API
    /// </summary>
...
#endif
    {
        ...
        {
            { "currency", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        private void ValidateParams(CurrencySymbolsQueryOptions options)
        {
