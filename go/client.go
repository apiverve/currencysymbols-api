...
const (
	baseURL        = "https://api.apiverve.com/v1/currencysymbols"
	defaultTimeout = 30 * time.Second
)

// Client is the Currency Symbols API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Currency Symbols API client.
...
// Execute makes a request to the Currency Symbols API with typed parameters.
//
