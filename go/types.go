// Package currencysymbols provides a Go client for the Currency Symbols API.
//
// For more information, visit: https://apiverve.com/marketplace/currencysymbols?utm_source=go&utm_medium=readme
package currencysymbols
...
// Request contains the parameters for the Currency Symbols API.
//
// Parameters:
//   - currency (required): string - The currency code for which you want to get the symbol
type Request struct {
...
// ResponseData contains the data returned by the Currency Symbols API.
type ResponseData struct {
	CountriesFound []CountriesFoundItem `json:"countriesFound"`
	Currency string `json:"currency"`
}

// CountriesFoundItem represents an item in the CountriesFound array.
type CountriesFoundItem struct {
	CountryName string `json:"country_name"`
	CurrencyName string `json:"currency_name"`
	CurrencyIsoCode string `json:"currency_iso_code"`
	CurrencyNumber string `json:"currency_number"`
	CurrencyMnrUnts string `json:"currency_mnr_unts"`
